...
public interface IGameService {
    ...
    List<Game> getGames();
    String createGame(Dictionary dictionary, RealmList<Team> teams, boolean istask, boolean islastword
            , boolean penalty, int countwords, int seconds, boolean isfinish, String datestart);
    String updateGame(String idgame, Dictionary dictionary,RealmList<Team> teams, boolean istask, boolean islastword
            ,boolean penalty, int countwords, int seconds, boolean isfinish, String datestart);
